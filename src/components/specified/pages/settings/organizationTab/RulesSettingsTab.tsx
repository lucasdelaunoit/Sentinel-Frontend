  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center gap-1.5 mt-4 text-[11px] font-medium text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
      >
        <CaretDownIcon
          size={12}
          weight="bold"
        ...
        />
        Advanced rules
        <span className="text-muted-foreground/60">— rarely need changing</span>
      </button>
