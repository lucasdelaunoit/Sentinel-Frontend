...
const fieldVariants = cva("group/field flex w-full gap-2 data-[invalid=true]:text-destructive-foreground", {
  variants: {
    orientation: {
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-xs font-normal text-destructive-foreground", className)}
      {...props}
    >
      {content}
    </div>
